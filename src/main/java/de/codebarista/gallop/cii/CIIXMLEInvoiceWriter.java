...
import de.codebarista.gallop.model.ItemAttribute;
...
public class CIIXMLEInvoiceWriter {
    ...
    private Element createExchangedDocument(XmlDocumentBuilder builder, List<InvoiceNote> invoiceNotes) {
        ...
        for (InvoiceNote note : invoiceNotes) {
            if (GallopUtils.isNotNullOrBlank(note.getNote())) {
    ...
    private static Element createTradeLineItem(Item lineItem, XmlDocumentBuilder builder) {
        ...
        if (GallopUtils.isNotNullOrBlank(lineItem.getSellerAssignedId())) {
        ...
        if (GallopUtils.isNotNullOrBlank(lineItem.getDescription())) {
    ...
    private Element createTradeHeader(XmlDocumentBuilder builder) {
        ...
        if (GallopUtils.isNotNullOrBlank(invoice.getLeitwegId())) {
        ...
        if (sellerInfo != null) {
            ...
            if (GallopUtils.isNotNullOrBlank(sellerInfo.getSellerAdditionalLegalInfo())) {
                seller.appendChild(createDescription(builder, sellerInfo.getSellerAdditionalLegalInfo()));
            }
            if (GallopUtils.isNotNullOrBlank(sellerInfo.getLegalRegistrationIdentifier())) {
            ...
            if (GallopUtils.isNotNullOrBlank(sellerInfo.getVatId())) {
                seller.appendChild(createTaxRegistration(builder, "VA", sellerInfo.getVatId()));
            }
            if (GallopUtils.isNotNullOrBlank(sellerInfo.getSellerTaxRegistrationIdentifier())) {
        ...
        if (buyerInfo != null) {
            ...
            if (GallopUtils.isNotNullOrBlank(buyerInfo.getLegalRegistrationIdentifier())) {
                Element specifiedLegalOrganization = builder.createElement(NS_RAM, "SpecifiedLegalOrganization");
                specifiedLegalOrganization.appendChild(
                        createID(builder,
            ...
            if (GallopUtils.isNotNullOrBlank(buyerInfo.getVatId())) {
    ...
    private Element createTradeSettlement(XmlDocumentBuilder builder) {
        ...
        if (paymentInstructions != null && GallopUtils.isNotNullOrBlank(paymentInstructions.getRemittanceInfo())) {
        ...
        if (paymentInstructions != null && GallopUtils.isNotNullOrBlank(paymentInstructions.getPaymentTerms())) {
    ...
    private static Element createPaymentMeans(XmlDocumentBuilder builder, PaymentInstructions paymentInstructions) {
        ...
        if (paymentInstructions != null) {
            ...
            if (GallopUtils.isNotNullOrBlank(paymentInstructions.getMeansText())) {
            ...
            for (CreditTransfer transfer : paymentInstructions.getCreditTransfers()) {
                ...
                if (GallopUtils.isNotNullOrBlank(transfer.getAccountName())) {
                ...
                if (GallopUtils.isNotNullOrBlank(transfer.getBic())) {
    ...
    private static Element createID(XmlDocumentBuilder builder, String id, String schemeID) {
        ...
        if (GallopUtils.isNotNullOrBlank(schemeID)) {
