 ...
 * What that XML looks like for realistic input is {@link EInvoiceWriterScenariosTest}'s concern.
 */
public class EInvoiceWriterNullableTest {
    ...
    public void doesNotFailWithEmptyInvoice(EInvoiceFormat format) {
        assertThat(EInvoiceWriter.generateCIIXML(Invoice.create(), format)).isNotEmpty();
    }

    @Test
    public void doesNotFailWithEmptyPaymentInstructions() {
        assertThat(EInvoiceWriter.generateCIIXML(Invoice.create()
